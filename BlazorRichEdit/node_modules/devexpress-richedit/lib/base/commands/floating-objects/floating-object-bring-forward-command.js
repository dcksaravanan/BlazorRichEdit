...
var FloatingObjectBringForwardBackwardCommandBase = (function (_super) {
    ...
    FloatingObjectBringForwardBackwardCommandBase.prototype.executeCore = function (_state, _parameter) {
        ...
        var specialRunInfo = this.selection.specialRunInfo;
        if (this.selection.activeSubDocument.getRunByPosition(specialRunInfo.getPosition())
            .anchorInfo.isBehindDoc != this.isBehindDoc())
            this.history.addAndRedo(new anchor_info_property_history_item_1.AnchorInfoPropertyHistoryItem(modelManipulator, new sub_document_1.SubDocumentInterval(specialRunInfo.getParentSubDocument(), new fixed_1.FixedInterval(this.selection.specialRunInfo.getPosition(), 1)), this.isBehindDoc(), modelManipulator.floatingObject.anchorInfo.isBehindDoc));
        return true;
    };
