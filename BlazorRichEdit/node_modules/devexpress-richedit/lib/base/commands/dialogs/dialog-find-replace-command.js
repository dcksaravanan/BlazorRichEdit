...
var DialogFindReplaceCommand = (function (_super) {
    ...
    DialogFindReplaceCommand.getTextForward = function (control, subDocument, startPosition, endPosition, length) {
        var text = "";
        var charIterator = new find_replace_helper_1.ForwardCharacterIterator(control.modelManager, control.layoutFormatterManager, control.selection, subDocument, startPosition, endPosition);
    ...
    DialogFindReplaceCommand.getTextBackward = function (control, subDocument, startPosition, endPosition, length) {
        var text = "";
        var charIterator = new find_replace_helper_1.BackwardCharacterIterator(control.modelManager, control.layoutFormatterManager, control.selection, subDocument, endPosition, startPosition);
