...
var DialogFontCommand = (function (_super) {
    ...
    DialogFontCommand.prototype.getState = function () {
        ...
        state.visible = control_1.ControlOptions.isVisible(this.control.modelManager.richOptions.control.characterFormatting) && !this.selection.specialRunInfo.isPictureSelected();
        return state;
    };
