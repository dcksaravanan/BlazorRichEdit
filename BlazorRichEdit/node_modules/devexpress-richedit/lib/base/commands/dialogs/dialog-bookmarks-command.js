...
var DialogBookmarksCommand = (function (_super) {
    ...
    DialogBookmarksCommand.prototype.createParameters = function (_options) {
        ...
        parameters.bookmarks = list_1.ListUtils.map(this.control.modelManager.model.getAllBookmarks(false), function (bm) { return new BookmarkDioalogInfo(bm.name, bm.start); });
...
exports.BookmarkDioalogInfo = BookmarkDioalogInfo;
