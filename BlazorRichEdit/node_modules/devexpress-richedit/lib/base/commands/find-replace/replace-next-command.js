...
var ReplaceNextCommand = (function (_super) {
    ...
    ReplaceNextCommand.prototype.executeCore = function (_state, options) {
        ...
        var findReplaceHelper = new find_replace_helper_1.FindReplaceHelper(this.control.modelManager, this.control.layoutFormatterManager, this.control.selection, options.subDocument, this.control.layout, function (interval) {
