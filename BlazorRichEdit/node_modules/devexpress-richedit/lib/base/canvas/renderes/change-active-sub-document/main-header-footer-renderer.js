...
var MainHeaderFooterRenderer = (function (_super) {
    ...
    MainHeaderFooterRenderer.prototype.activateElement = function (pageAreaElement) {
        ...
        pageAreaElement.style.backgroundColor = color_2.ColorUtils.colorToHash(color_1.ColorHelper.isEmptyBgColor(pageColor) ?
            color_2.ColorUtils.LIGHT_COLOR : pageColor);
        return true;
    };
