...
var RichEditCore = (function () {
    ...
    RichEditCore.prototype.importHtml = function (elements, interval) {
        ...
        if (exportedRangeCopy && this.isUsedInnerClipboard(elements)) {
            insertedInterval = exportedRangeCopy.insertTo(this.modelManager.modelManipulator, new sub_document_1.SubDocumentPosition(subDocument, interval.start));
        }
        else {
    ...
    RichEditCore.prototype.getModifiedState = function () {
        ...
        else if (this.serverDispatcher.lastSavedHistoryItemId != this.modelManager.history.getCurrentItemId())
            return json_top_level_enums_1.IsModified.True;
        return json_top_level_enums_1.IsModified.False;
    };
    RichEditCore.prototype.setModifiedFalse = function () {
        this.serverDispatcher.lastSavedHistoryItemId = this.modelManager.history.getCurrentItemId();
    };
