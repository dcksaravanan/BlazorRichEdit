        ...
        number_1.NumberMapUtils.forEach(this.getSubDocumentData(subDocument), function (reqData, fieldId) {
            ...
            switch (reqData.serverUpdateFieldType) {
                case field_request_manager_1.ServerUpdateFieldType.DocVariable: {
                    ...
                    }, interval_1.convertToIntervalApi(docVarData.fieldInterval), docVarData.fieldName, docVarData.parameters.map(function (p) { return p.text; }));
        ...
        number_1.NumberMapUtils.forEach(this.getSubDocumentData(subDocument), function (reqData, fieldId) {
            ...
            switch (reqData.serverUpdateFieldType) {
                case field_request_manager_1.ServerUpdateFieldType.DocVariable: {
                    ...
                    if (eventArg.value instanceof processor_1.DocumentProcessorBaseApi) {
                        var rangeCopy = new create_range_copy_operation_1.RangeCopy(eventArg.value._processor.modelManager.model, !eventArg.keepLastParagraph);
                        result.add(fieldId, (_a = {},
                            _a[json_field_enums_1.JSONUpdateFieldCommandResult.DocumentModel] = rangeCopy,
                            _a));
                    }
                        ...
                        result.add(fieldId, (_b = {},
                            _b[json_field_enums_1.JSONUpdateFieldCommandResult.SimpleText] = eventArg.value,
                            _b));
                    }
                    break;
                }
                case field_request_manager_1.ServerUpdateFieldType.MergeField: {
                    var mergeFieldData = reqData;
                    var value = _this.getRecordValue(mergeFieldData.fieldName);
                    result.add(fieldId, (_c = {},
                        _c[json_field_enums_1.JSONUpdateFieldCommandResult.SimpleText] = String(value),
                        _c));
                    break;
                }
            }
