...
exports.DocumentProcessorBase = processor_1.DocumentProcessorBaseApi;
var field_1 = require("../../model-api/field");
exports.FieldName = field_1.FieldNameApi;
var model_font_1 = require("../../model-api/fonts/model-font");
exports.Font = model_font_1.ModelFontApi;
var enum_1 = require("../../model-api/formats/enum");
exports.DocumentFormat = enum_1.DocumentFormatApi;
var exporter_1 = require("../../model-api/formats/exporter");
var range_permission_1 = require("../../model-api/range-permission");
exports.RangePermission = range_permission_1.RangePermissionApi;
...
exports.AuthenticationOptions = authentication_options_1.AuthenticationOptionsApi;
var mail_merge_options_1 = require("./api/mail-merge-options");
exports.MailMergeOptions = mail_merge_options_1.MailMergeOptionsApi;
var range_permission_options_1 = require("./api/range-permission-options");
exports.RangePermissionOptions = range_permission_options_1.RangePermissionOptionsApi;
var simple_view_1 = require("./api/simple-view");
exports.Paddings = simple_view_1.Paddings;
var client_events_1 = require("./client-events");
exports.Events = client_events_1.Events;
var commands_1 = require("./commands/commands");
var enum_2 = require("./commands/enum");
exports.ContextMenuCommandId = enum_2.ContextMenuCommandId;
exports.FileTabCommandId = enum_2.FileTabCommandId;
exports.FloatingObjectsFormatTabCommandId = enum_2.FloatingObjectsFormatTabCommandId;
exports.HeaderAndFooterTabCommandId = enum_2.HeaderAndFooterTabCommandId;
exports.HomeTabCommandId = enum_2.HomeTabCommandId;
exports.InsertTabCommandId = enum_2.InsertTabCommandId;
exports.MailMergeTabCommandId = enum_2.MailMergeTabCommandId;
exports.PageLayoutTabCommandId = enum_2.PageLayoutTabCommandId;
exports.ReferencesTabCommandId = enum_2.ReferencesTabCommandId;
exports.TableDesignTabCommandId = enum_2.TableDesignTabCommandId;
exports.TableLayoutTabCommandId = enum_2.TableLayoutTabCommandId;
exports.ViewTabCommandId = enum_2.ViewTabCommandId;
var menu_1 = require("./context-menu/menu");
var document_processor_1 = require("./document-processor");
exports.DocumentProcessor = document_processor_1.DocumentProcessorApi;
...
var RichEditPublic = (function () {
    function RichEditPublic(htmlElement, options) {
        ...
        if (initialDoc && common_1.isDefined(initialDoc.content)) {
            ...
            this.newDocument();
            setTimeout(function () { return afterDocumentOpened(function () { }); }, 0);
        }
    }
    ...
    RichEditPublic.prototype.executeCommand = function (commandId, parameter) {
        commands_1.executeApiCommand(this._native.core.commandManager, commandId, parameter);
    };
    RichEditPublic.prototype.getCommandState = function (commandId) {
        var _a;
        return (_a = commands_1.getApiCommandState(this._native.core.commandManager, commandId)) !== null && _a !== void 0 ? _a : new commands_1.CommandState(false);
    };
...
exports.CharacterProperties = character_properties_1.CharacterPropertiesApi;
exports.CharacterPropertiesScript = character_properties_1.CharacterPropertiesScriptApi;
var field_2 = require("../../model-api/field");
exports.HyperlinkInfo = field_2.HyperlinkInfoApi;
var interval_1 = require("../../model-api/interval");
exports.Interval = interval_1.IntervalApi;
var enums_1 = require("../../model-api/lists/enums");
exports.ListType = enums_1.ListTypeApi;
exports.ListLevelNumberAlignment = enums_1.ListLevelNumberAlignmentApi;
exports.ListLevelFormat = enums_1.ListLevelFormatApi;
var list_level_settings_1 = require("../../model-api/lists/list-level-settings");
exports.ListLevelSettings = list_level_settings_1.ListLevelSettingsApi;
var lists_1 = require("../../model-api/lists/lists");
exports.List = lists_1.ListApi;
var paragraph_1 = require("../../model-api/paragraph");
exports.ParagraphAlignment = paragraph_1.ParagraphAlignmentApi;
exports.ParagraphLineSpacingType = paragraph_1.ParagraphLineSpacingTypeApi;
exports.ParagraphFirstLineIndent = paragraph_1.ParagraphFirstLineIndentApi;
exports.ParagraphProperties = paragraph_1.ParagraphPropertiesApi;
exports.Paragraph = paragraph_1.ParagraphApi;
var size_1 = require("../../model-api/size");
exports.Margins = size_1.MarginsApi;
exports.Size = size_1.SizeApi;
var sub_document_2 = require("../../model-api/sub-document");
exports.SubDocumentType = sub_document_2.SubDocumentTypeApi;
exports.HeaderFooterType = sub_document_2.HeaderFooterTypeApi;
exports.SectionBreakType = sub_document_2.SectionBreakTypeApi;
exports.SubDocument = sub_document_2.SubDocumentApi;
var bookmark_1 = require("../../model-api/bookmark");
exports.Bookmark = bookmark_1.BookmarkApi;
var bookmark_2 = require("../../base-api/bookmark");
exports.BookmarkBase = bookmark_2.BookmarkBaseApi;
var table_1 = require("../../model-api/table/table");
exports.Table = table_1.TableApi;
var section_1 = require("../../model-api/section");
exports.Section = section_1.SectionApi;
var sub_documents_collection_1 = require("../../base-api/collections/sub-documents-collection");
exports.SubDocumentCollectionBase = sub_documents_collection_1.SubDocumentCollectionBaseApi;
var key_code_2 = require("../../base-api/key-code");
exports.ShortcutOptions = key_code_2.ShortcutOptions;
var document_2 = require("../../model-api/document");
exports.RichEditDocumentBase = document_2.RichEditDocumentApi;
var bookmark_collection_1 = require("../../base-api/collections/bookmark-collection");
exports.BookmarkCollectionBase = bookmark_collection_1.BookmarkCollectionBaseApi;
var field_3 = require("../../model-api/field");
exports.Field = field_3.FieldApi;
var field_collection_1 = require("../../model-api/collections/field-collection");
exports.UpdateFieldsOptions = field_collection_1.UpdateFieldsOptionsApi;
var field_4 = require("../../model-api/field");
exports.Hyperlink = field_4.HyperlinkApi;
var table_cell_1 = require("../../model-api/table/table-cell");
exports.TableCell = table_cell_1.TableCellApi;
var table_row_1 = require("../../model-api/table/table-row");
exports.TableRow = table_row_1.TableRowApi;
var image_enums_1 = require("../../model-api/images/image-enums");
exports.WrapType = image_enums_1.WrapTypeApi;
exports.WrapSide = image_enums_1.WrapSideApi;
exports.FloatingObjectHorizontalAlignment = image_enums_1.FloatingObjectHorizontalAlignmentApi;
exports.FloatingObjectHorizontalAnchorElement = image_enums_1.FloatingObjectHorizontalAnchorElementApi;
exports.FloatingObjectHorizontalPositionType = image_enums_1.FloatingObjectHorizontalPositionTypeApi;
exports.FloatingObjectVerticalAnchorElement = image_enums_1.FloatingObjectVerticalAnchorElementApi;
exports.FloatingObjectVerticalAlignment = image_enums_1.FloatingObjectVerticalAlignmentApi;
exports.FloatingObjectVerticalPositionType = image_enums_1.FloatingObjectVerticalPositionTypeApi;
var image_interfaces_1 = require("../../model-api/images/image-interfaces");
exports.HorizontalAbsolutePosition = image_interfaces_1.HorizontalAbsolutePositionApi;
exports.HorizontalAlignedPosition = image_interfaces_1.HorizontalAlignedPositionApi;
exports.HorizontalRelativePosition = image_interfaces_1.HorizontalRelativePositionApi;
exports.VerticalAbsolutePosition = image_interfaces_1.VerticalAbsolutePositionApi;
exports.VerticalAlignedPosition = image_interfaces_1.VerticalAlignedPositionApi;
exports.VerticalRelativePosition = image_interfaces_1.VerticalRelativePositionApi;
var floating_image_1 = require("../../model-api/images/floating-image");
exports.FloatingImage = floating_image_1.FloatingImageApi;
var inline_image_1 = require("../../model-api/images/inline-image");
exports.InlineImage = inline_image_1.InlineImageApi;
var image_1 = require("../../model-api/images/image");
exports.Image = image_1.ImageApi;
var images_1 = require("../../model-api/images/images");
exports.Images = images_1.ImagesApi;
var image_iterator_1 = require("../../model-api/images/image-iterator");
exports.ImageIterator = image_iterator_1.ImageIteratorApi;
var item_1 = require("./context-menu/item");
exports.ContextMenuItem = item_1.ContextMenuItem;
var utils_3 = require("./utils");
exports.Utils = utils_3.Utils;
var characters_1 = require("./characters");
exports.Characters = characters_1.Characters;
