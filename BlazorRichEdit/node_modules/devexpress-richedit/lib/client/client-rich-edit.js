...
var ClientRichEdit = (function () {
    ...
    ClientRichEdit.prototype.dispose = function () {
        ...
        this.clientQuickSearchPanel.dispose();
        this.events.clear();
        ...
        this.clientQuickSearchPanel = null;
        this.publicRichEdit = null;
    ...
    ClientRichEdit.prototype.createCore = function (settings) {
        ...
        this.core = new client_rich_edit_core_1.ClientRichEditCore(this, this.name, this.element, '', settings.readOnly, this.barHolder, settings.unit, _constants_1.Constants.ruler, options, settings.view, this.getStringResources());
    };
    ...
    ClientRichEdit.prototype.initQuickSearchPanel = function () {
        this.clientQuickSearchPanel = new client_quick_search_panel_1.ClientQuickSearchPanel(this, this.core.searchManager);
    };
    ...
    ClientRichEdit.prototype.adjustControl = function () {
        if (this.core) {
            ...
            var rulerHeight = this.core.horizontalRulerControl.getHeight() + 2;
            this.core.viewManager.canvas.style.height = this.element.offsetHeight - rulerHeight - ribbonHeight + "px";
    ...
    Object.defineProperty(ClientRichEdit.prototype, "documentSaved", {
        get: function () {
            return this.core.serverDispatcher.lastSavedHistoryItemId === this.core.modelManager.history.getCurrentItemId();
        },
        set: function (state) {
            var _a, _b;
            if (state) {
                this.core.serverDispatcher.lastSavedHistoryItemId = this.core.modelManager.history.getCurrentItemId();
                this.core.barHolder.updateItemsState((_a = {}, _a[client_command_1.RichEditClientCommand.ExportDocument] = true, _a));
            }
            else {
                if (this.core.serverDispatcher.lastSavedHistoryItemId == this.core.modelManager.history.getCurrentItemId()) {
                    this.core.serverDispatcher.lastSavedHistoryItemId = this.core.modelManager.history.getCurrentItemId() - 1;
    ...
    ClientRichEdit.prototype.prepareFullScreenMode = function () {
        ...
        attr_1.AttrUtils.changeElementStyleAttribute(mainElement, browser_1.Browser.IE ? "borderTopWidth" : "border-top-width", "0px");
        attr_1.AttrUtils.changeElementStyleAttribute(mainElement, browser_1.Browser.IE ? "borderLeftWidth" : "border-left-width", "0px");
        attr_1.AttrUtils.changeElementStyleAttribute(mainElement, browser_1.Browser.IE ? "borderRightWidth" : "border-right-width", "0px");
        attr_1.AttrUtils.changeElementStyleAttribute(mainElement, browser_1.Browser.IE ? "borderBottomWidth" : "border-bottom-width", "0px");
        ...
        attr_1.AttrUtils.changeElementStyleAttribute(mainElement, browser_1.Browser.IE ? "zIndex" : "z-index", '1001');
