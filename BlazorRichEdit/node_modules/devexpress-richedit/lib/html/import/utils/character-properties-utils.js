...
var HtmlImporterMaskedCharacterProperties = (function () {
    ...
    HtmlImporterMaskedCharacterProperties.prototype.importUnderlineType = function () {
        if (/.*underline.*/gi.test(this.currentStyle.textDecoration)) {
            ...
            this.result.fontUnderlineType = utils_1.HtmlImportUtils.getPropertyByMap(HtmlImporterMaskedCharacterProperties.MapUnderlineStyleToType, this.currentStyle.borderBottomStyle, this.result.fontUnderlineType);
            this.result.setUseValue(enums_1.CharacterPropertiesMask.UseFontUnderlineType, true);
        }
    };
    ...
    HtmlImporterMaskedCharacterProperties.MapUnderlineStyleToType = new map_creator_1.MapCreator()
        .add("solid", enums_1.UnderlineType.Single)
        .add("dashed", enums_1.UnderlineType.Dashed)
        .add("dotted", enums_1.UnderlineType.Dotted)
        .add("double", enums_1.UnderlineType.Double)
        .get();
