...
var DefaultDestination = (function (_super) {
    ...
    DefaultDestination.onSectionPageNumberingStart = function (_importer, _parameterValue, _hasParameter) {
    };
    DefaultDestination.onSectionPageNumberingContinuous = function (_importer, _parameterValue, _hasParameter) {
    };
    DefaultDestination.onSectionPageNumberingRestart = function (_importer, _parameterValue, _hasParameter) {
    };
