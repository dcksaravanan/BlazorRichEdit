...
export declare class RtfPositionState {
    ...
    constructor(subDocument: SubDocument, paragraph: Paragraph, fields: Stack<RtfFieldInfo>, bookmarks: Record<string, ImportBookmarkInfo>, sectionProperties: Stack<RtfSectionProperties>, tableReader: RtfTableReader);
}
export declare class RtfImportData {
    ...
    readonly savedStatesCount: number;
