...
var RtfShapeImportHelper = (function () {
    ...
    RtfShapeImportHelper.prototype.applyDrawingObjectRunProperties = function (anchorInfo, nonVisualDrawingObjectProperties) {
        this.setDefaults(anchorInfo);
        this.applyRunProperties(anchorInfo);
        this.applyContainerProperties(anchorInfo);
    ...
    RtfShapeImportHelper.prototype.applyAnchoredTextBoxRunProperties = function (run) {
        ...
        this.applyDrawingObjectRunProperties(run.anchorInfo, run.containerProperties);
    };
    RtfShapeImportHelper.prototype.applyAnchoredPictureRunProperties = function (run) {
        ...
        this.applyShapeProperties(run.shape);
        this.applyDrawingObjectRunProperties(run.anchorInfo, run.info.nonVisualDrawingProperties);
    };
    ...
    RtfShapeImportHelper.prototype.applyContainerProperties = function (anchorInfo) {
        new rtf_container_properties_helper_1.RtfContainerPropertiesHelper(this.shapeProperties).applyProperties(anchorInfo);
    };
