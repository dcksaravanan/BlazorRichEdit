...
export declare abstract class RtfAnchoredRunExporter {
    ...
    protected constructor(rtfBuilder: RtfBuilder, anchorInfo: AnchorInfo, shape: Shape, size: AnchorInlineBaseSize);
    abstract useAbsoluteWidth(): boolean;
    abstract useAbsoluteHeight(): boolean;
