...
var LayoutInvalidator = (function () {
    ...
    LayoutInvalidator.prototype.onChangedSection = function (sectionIndex) {
        log_1.Log.print(log_source_1.LogSource.LayoutFormatterInvalidator, "onChangedSection", "sectionIndex:" + sectionIndex);
        var section = this.model.sections[sectionIndex];
        var pages = this.layout.pages;
