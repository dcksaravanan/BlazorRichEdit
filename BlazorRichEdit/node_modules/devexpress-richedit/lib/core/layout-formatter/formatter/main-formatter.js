...
var MainFormatter = (function (_super) {
    ...
    MainFormatter.prototype.processStatePageStart = function () {
        ...
        switch (tryReuseResult) {
            ...
            case TryReusePageResult.RestartFromPageStartPosition:
                this.manager.invalidator.onIntervalChanged(this.subDocument.id, new fixed_1.FixedInterval(list_1.ListUtils.last(list_1.ListUtils.last(list_1.ListUtils.last(this.manager.layout.pages[this.layoutPosition.pageIndex].mainSubDocumentPageAreas).columns).tablesInfo)
    ...
    MainFormatter.prototype.tryReusePage = function (pageBounds) {
        ...
        if (column.tablesInfo[0] && !list_1.ListUtils.last(column.tablesInfo).isLastLayoutColumnInModelTable() &&
