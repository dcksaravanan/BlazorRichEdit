    ...
    ModelChangesListener.prototype.modelChanged = function (change) {
        switch (change.type) {
            ...
            case enums_1.ModelChangeType.SectionFormattingChanged: {
                ...
                this.invalidator.onChangedSection(change.sectionIndex);
                break;
            }
            ...
            case enums_1.ModelChangeType.InlinePicturesUpdated: {
                log_1.Log.print(log_source_1.LogSource.LayoutFormatterNotifier, "modelChanged.InlinePictureInserted", function () { return "subDocumentId:" + change.subDocumentId; });
