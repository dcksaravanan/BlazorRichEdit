    ...
    RowTabInfo.prototype.calculateActualTabWidth = function (prevTabBox) {
        ...
        switch (this.lastTabPosition.alignment) {
            ...
            case paragraph_1.TabAlign.Right: {
                var lastVisibleBox = this.row.boxes[Math.max(0, box_aligner_1.BoxAligner.findLastVisibleBoxIndex(this.row.boxes))];
                var lastTextBoxRightBound = lastVisibleBox.right;
