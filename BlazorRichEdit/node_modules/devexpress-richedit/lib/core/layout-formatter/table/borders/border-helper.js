            ...
            for (var cellIndex = 0, cell; cell = cells[cellIndex]; cellIndex++) {
                ...
                if (cellSpacing > 0) {
                    ...
                    if (cellIndex == 0)
                        ...
                        if (leftCell.verticalMerging != table_base_structures_1.TableCellMergingState.Continue)
                        ...
                        cellBorders.push(this.mergeVerticalBorders(cellForBorders, table_cell_properties_merger_1.TableCellPropertiesMergerBorderLeft, leftCellForBorders, table_cell_properties_merger_1.TableCellPropertiesMergerBorderRight, false, this.tblbrdProvider.verticalBorder, function (_borderWidth) {
