...
var PictureManipulator = (function (_super) {
    ...
    PictureManipulator.prototype.insertInlinePictureInner = function (subDocPos, charPropsBundle, picInfo, options) {
        ...
        this.modelManipulator.notifyModelChanged(new inline_picture_inserted_1.InlinePictureInsertedSubDocumentChange(subDocPos.subDocument.id, subDocPos.position, runPicInfo));
    ...
    PictureManipulator.prototype.insertAnchoredPictureInner = function (subDocPos, charPropsBundle, picInfo, options) {
        ...
        if (cacheInfo.isLoaded)
            this.loader.sizeUpdater.update(cacheInfo, false);
        this.modelManipulator.notifyModelChanged(new anchored_pictureinserted_1.AnchoredPictureInsertedSubDocumentChange(subDocPos.subDocument.id, pictureRun.anchoredObjectID, subDocPos.position, cacheInfo.currId, runPicInfo.size, runPicInfo.anchorInfo));
