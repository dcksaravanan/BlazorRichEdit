        ...
        while (iterator.moveNext()) {
            ...
            switch (currentRun.getType()) {
                ...
                case run_type_1.RunType.AnchoredTextBoxRun:
                    ...
                    result.registerItem(new history_runs_1.HistoryRunAnchoredTextBox(currentRun.getCharPropsBundle(this.modelManipulator.model), new text_box_manipulator_1.BaseTextBoxInfo(this.modelManipulator.model.subDocuments[currentAnchoredTextBoxRun.subDocId], currentAnchoredTextBoxRun.size.clone(), currentAnchoredTextBoxRun.shape.clone(), currentAnchoredTextBoxRun.anchorInfo.clone(), currentAnchoredTextBoxRun.textBoxProperties.clone()), currentInterval.start));
                    break;
            }
        }
        iterator.reset();
