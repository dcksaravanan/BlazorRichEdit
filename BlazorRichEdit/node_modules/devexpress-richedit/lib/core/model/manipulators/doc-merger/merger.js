        ...
        while (constRunIterator.moveNext()) {
            ...
            switch (currentRun.getType()) {
                ...
                case run_type_1.RunType.AnchoredTextBoxRun: {
                    ...
                    var newAnchoredTextBox = this.modelManipulator.textBox.insertAnchoredTextBox(new sub_document_1.SubDocumentPosition(targetSubDocument, toCurrentPosition), currentRun.getCharPropsBundle(toDocumentModel), new text_box_manipulator_1.BaseTextBoxInfo(null, currentAnchoredTextBoxRun.size.clone(), currentAnchoredTextBoxRun.shape.clone(), currentAnchoredTextBoxRun.anchorInfo.clone(), currentAnchoredTextBoxRun.textBoxProperties.clone()));
