...
var ParagraphManipulator = (function (_super) {
    ...
    ParagraphManipulator.prototype.insertParagraphInner = function (params) {
        ...
        if (this.insertParagraphInEnd(subDocument, params.subDocPos.position, params.charPropsBundle)) {
    ...
    ParagraphManipulator.prototype.insertParagraphInEnd = function (subDocument, position, charPropsBundle) {
