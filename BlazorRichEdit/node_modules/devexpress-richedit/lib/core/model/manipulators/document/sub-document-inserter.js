...
var SubDocumentInserter = (function () {
    ...
    SubDocumentInserter.prototype.anchoredTextBoxRunHandler = function (currentRun) {
        ...
        if (this.targetSubDocument.isTextBox()) {
            ...
            var newAnchoredTextBox = this.targetModelManipulator.textBox.insertAnchoredTextBox(this.currInsertSubDocumentPosition, this.getCharPropsBundle(currentRun), new text_box_manipulator_1.BaseTextBoxInfo(null, currentAnchoredTextBoxRun.size.clone(), currentAnchoredTextBoxRun.shape.clone(), currentAnchoredTextBoxRun.anchorInfo.clone(), currentAnchoredTextBoxRun.textBoxProperties.clone()));
            var sourceSubDoc = this.sourceSubDocument.documentModel.subDocuments[currentAnchoredTextBoxRun.subDocId];
            var targetSubDoc = this.targetSubDocument.documentModel.subDocuments[newAnchoredTextBox.subDocId];
