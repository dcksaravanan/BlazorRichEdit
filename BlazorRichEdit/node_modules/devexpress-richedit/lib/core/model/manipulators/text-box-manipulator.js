...
var BaseTextBoxInfo = (function () {
    function BaseTextBoxInfo(innerSubDocument, size, shape, anchorInfo, textBoxProperties) {
...
var TextBoxManipulator = (function (_super) {
    ...
    TextBoxManipulator.prototype.insertAnchoredTextBox = function (subDocPos, charPropsBundle, textBoxInfo) {
        ...
        this.modelManipulator.notifyModelChanged(new anchored_text_box_inserted_1.AnchoredTextBoxInsertedSubDocumentChange(subDocument.id, textBoxRun.anchoredObjectID, textBoxRun.subDocId, insertPositionAtStartDocument, textBoxInfo.anchorInfo));
