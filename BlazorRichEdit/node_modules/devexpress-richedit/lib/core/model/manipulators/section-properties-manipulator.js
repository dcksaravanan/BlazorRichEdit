...
var SectionPropertiesManipulatorBase = (function () {
    ...
    SectionPropertiesManipulatorBase.prototype.setValue = function (interval, newValue) {
        ...
        this.manipulator.notifyModelChanged(new section_formatting_changed_1.SectionFormattingChangedModelChange(sections[startSectionIndex], startSectionIndex, this.descriptor.getJSONProperty(), newState));
        return oldState;
    };
    SectionPropertiesManipulatorBase.prototype.restoreValue = function (state) {
        ...
        this.manipulator.notifyModelChanged(new section_formatting_changed_1.SectionFormattingChangedModelChange(sections[sectionIndex], sectionIndex, this.descriptor.getJSONProperty(), state));
    };
