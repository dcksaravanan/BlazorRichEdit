...
var DXColor = (function () {
    ...
    DXColor.transparent = color_1.ColorUtils.fromHashString("#FFFFFF", 255);
    DXColor.white = color_2.ColorHelper.getPredefinedColor(color_1.ColorUtils.colorNames.white);
    return DXColor;
}());
