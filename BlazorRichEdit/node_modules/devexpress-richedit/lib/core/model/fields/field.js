...
var Field = (function () {
    ...
    Field.prototype.clone = function (subDocument) {
        var result = new Field(subDocument.positionManager, this.index, this.getFieldStartPosition(), this.getSeparatorPosition(), this.getFieldEndPosition(), this.showCode, this.hyperlinkInfo.clone());
        result.sequenceInfo = this.sequenceInfo.clone();
        result.tcInfo = this.tcInfo.clone();
