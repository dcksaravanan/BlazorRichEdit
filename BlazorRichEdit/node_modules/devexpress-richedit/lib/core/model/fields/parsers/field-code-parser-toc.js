...
var FieldCodeParserToc = (function (_super) {
    ...
    FieldCodeParserToc.prototype.createToc = function (tocElements, params) {
        ...
        if (fieldsForUpdate.length > 0) {
            ...
            new tree_creator_1.FieldsWaitingForUpdate(this.modelManager, this.layoutFormatterManager, this.requestManager, new sub_document_1.SubDocumentIntervals(this.subDocument, intervalsForUpdate_1), new tree_creator_1.UpdateFieldsOptions(), function () { }).update(null);
        }
    };
