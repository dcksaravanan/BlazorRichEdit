...
var TableStyle = (function (_super) {
    tslib_1.__extends(TableStyle, _super);
    ...
    TableStyle.prototype.clone = function () {
        var newStyle = new TableStyle(this.styleName, this.localizedName, this.deleted, this.hidden, this.semihidden, this.isDefault, number_1.NumberMapUtils.map(this.conditionalStyles, function (cs) { return cs.clone(); }), this.baseConditionalStyle.clone(), this.base64EncodedImage);
        return newStyle;
    };
