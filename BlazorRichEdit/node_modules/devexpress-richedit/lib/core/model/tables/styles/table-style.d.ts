...
export declare class TableStyle extends StyleBase<TableStyle> implements ICloneable<TableStyle> {
    ...
    constructor(styleName: string, localizedName: string, deleted: boolean, hidden: boolean, semihidden: boolean, isDefault: boolean, conditionalStyles: Record<number, TableConditionalStyle>, baseConditionalStyle: TableConditionalStyle, base64EncodedImage: string);
    clone(): TableStyle;
}
