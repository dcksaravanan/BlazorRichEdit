...
var AnchoredPictureRunImporter = (function (_super) {
    ...
    AnchoredPictureRunImporter.prototype.makeRun = function (jsonRun, startOffset, paragraph, charPropsBundle) {
        ...
        var run = new anchored_picture_run_1.AnchoredPictureRun(startOffset, paragraph, charPropsBundle, new insert_picture_manipulator_params_1.AnchorPictureInfo(json_inline_picture_size_converter_1.JSONInlinePictureSizeConverterConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredPictureRunProperty.Size], cacheInfo), json_shape_converter_1.JSONShapeConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredPictureRunProperty.Shape]), json_anchor_info_converter_1.JSONAnchorInfoConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredPictureRunProperty.AnchorInfo]), new non_visual_drawing_object_info_1.NonVisualDrawingObjectInfo(), new non_visual_drawing_object_info_1.NonVisualDrawingObjectInfo()), -1);
        return run;
    };
...
var AnchoredTextBoxRunImporter = (function (_super) {
    ...
    AnchoredTextBoxRunImporter.prototype.makeRun = function (jsonRun, startOffset, paragraph, charPropsBundle) {
        return new anchored_text_box_run_1.AnchoredTextBoxRun(startOffset, paragraph, charPropsBundle, json_shape_converter_1.JSONShapeConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredTextBoxRunProperty.Shape]), jsonRun[json_run_enums_1.JSONAnchoredTextBoxRunProperty.SubDocId], json_anchor_text_box_size_converter_1.JSONAnchorTextBoxSizeConverterConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredTextBoxRunProperty.Size]), json_anchor_info_converter_1.JSONAnchorInfoConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredTextBoxRunProperty.AnchorInfo]), -1, json_text_box_properties_converter_1.JSONTextBoxPropertiesConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONAnchoredTextBoxRunProperty.TextBoxProperties]));
    };
...
var InlinePictureRunImporter = (function (_super) {
    ...
    InlinePictureRunImporter.prototype.makeRun = function (jsonRun, startOffset, paragraph, charPropsBundle) {
        ...
        var realId = this.imageCorrespondence ? this.imageCorrespondence[initId] : initId;
        var cacheInfo = this.imageCache.getPictureData(realId);
        var run = new inline_picture_run_1.InlinePictureRun(startOffset, paragraph, charPropsBundle, new insert_picture_manipulator_params_1.InlinePictureInfo(json_inline_picture_size_converter_1.JSONInlinePictureSizeConverterConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONInlinePictureRunProperty.Size], cacheInfo), json_shape_converter_1.JSONShapeConverter.convertFromJSON(jsonRun[json_run_enums_1.JSONInlinePictureRunProperty.Shape]), -1, new non_visual_drawing_object_info_1.NonVisualDrawingObjectInfo(), new non_visual_drawing_object_info_1.NonVisualDrawingObjectInfo()));
        return run;
    };
