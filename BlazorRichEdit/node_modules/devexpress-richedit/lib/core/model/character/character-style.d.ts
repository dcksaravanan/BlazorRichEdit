...
export declare class CharacterStyle extends StyleBase<CharacterStyle> implements ICloneable<CharacterStyle> {
    ...
    constructor(styleName: string, localizedName: string, deleted: boolean, hidden: boolean, semihidden: boolean, isDefault: boolean, maskedCharacterProperties: MaskedCharacterProperties, base64EncodedImage?: string);
