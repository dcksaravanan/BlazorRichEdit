...
export declare class FindReplaceHelper {
    ...
    constructor(modelManager: IModelManager, layoutFormatterManager: FormatterManager, selection: ISelectionBase, subDocument: SubDocument, layout: DocumentLayout, storeSelection: (interval: FixedInterval) => void);
    ...
    replaceAll(startWithPos: number): void;
...
export declare class CharacterIteratorBase {
    ...
    constructor(modelManager: IModelManager, layoutFormatterManager: FormatterManager, selection: ISelectionBase, subDocument: SubDocument, startPosition: number, endPosition: number);
