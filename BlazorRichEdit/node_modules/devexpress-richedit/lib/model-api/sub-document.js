...
var SubDocumentApi = (function () {
    ...
    SubDocumentApi.prototype.insertRtf = function (position, rtfText, callback) {
        ...
        if (!callback)
            callback = function () { };
        importer_1.insertRtfInSubDocumentPublic(this._processor.modelManager, this._subDocument, position, rtfText, this._processor, function (interval, isRtfValid) { return callback(interval_1.convertToIntervalApi(interval), isRtfValid); });
    };
    ...
    SubDocumentApi.prototype.insertContent = function (position, content, documentFormat, callback) {
        ...
        if (!callback)
            callback = function () { };
        importer_1.insertContentInSubDocumentPublic(this._processor.modelManager, this._subDocument, position, content, this._processor, coreDocumentFormat, function (interval, isRtfValid) { return callback(interval_1.convertToIntervalApi(interval), isRtfValid); });
    };
